...
const attractionsData = [
  ...
  },
  {
    ...
    fullDesc: "ชุมชนท่องเที่ยวเชิงหัตถศิลป์ที่มีชื่อเสียงโด่งดังไปทั่วโลก ฟื้นฟูเทคนิคการทอผ้ายกทองชั้นสูงแบบราชสำนักโบราณ ผสมผสานลวดลายไทยประยุกต์และสีธรรมชาติ",
  ...
  },
  {
    ...
    fullDesc: "ปราสาทหินทรายศิลปะบาปวน ก่อสร้างพุทธศตวรรษที่ 16-17 โดดเด่นด้วยงานแกะสลักหินทรายขาวอมชมพูประณีตคมชัดอย่างยิ่ง ภาพสลักพระอินทร์ทรงช้างเอราวัณและลวดลายกระหนกพวงมาลัยประดับรอบปรางค์",
    hours: "เปิดทุกวัน 07:30 – 18:00 น.",
